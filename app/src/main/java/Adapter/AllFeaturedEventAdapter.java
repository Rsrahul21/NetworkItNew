...
public class AllFeaturedEventAdapter extends RecyclerView.Adapter<AllFeaturedEventAdapter.FeatureViewHolder> {
    ...
    public AllFeaturedEventAdapter(Context context, ArrayList<EventData> data) {
